...
replace go.infratographer.com/load-balancer-api v0.3.1 => github.com/sthwang-metal/load-balancer-api v0.0.26

require (
	github.com/gobuffalo/packr/v2 v2.8.3
	github.com/labstack/echo/v4 v4.11.4
	go.infratographer.com/ipam-api v0.0.4
	go.infratographer.com/load-balancer-api v0.3.1
